...
const props = defineProps({
  ...
  stage: Object, // Education stage being edited
  errors: {
    required: true,
  }
});
...
// Populate form when editing a stage
...
<template>
  <VNavigationDrawer temporary :width="400" location="end" class="scrollable-content" :model-value="props.isDrawerOpen"
    ...
    <AppDrawerHeaderSection title="تعديل المرحلة التعليمية" @cancel="closeNavigationDrawer" />
