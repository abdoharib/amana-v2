...
watch(() => props.itemDetail, newItem => {
...
const onSubmit = () => {
    refForm.value?.validate().then(({ valid }) => {
        if (valid) {
            ...
            formData.append("prophet_story_id", props.itemId);

            emit('itemDetailData', formData);
...
<template>
    <VNavigationDrawer temporary :width="400" location="end" class="scrollable-content"
        ...
        <AppDrawerHeaderSection title="العناصر" @cancel="closeNavigationDrawer" />
                ...
                <VCardText>
                    ...
                    <VForm ref="refForm" v-model="isFormValid" @submit.prevent="onSubmit">
                        <VRow>
                            ...
                            <!-- 👉 Image Path -->
                            <VCol cols="12">
                                <VFileInput label="تحميل الصوت" @change="handleFileChange" />
                            </VCol>
                            <VCol cols="12">
