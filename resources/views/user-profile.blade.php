...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen py-8 px-4">
    <div class="max-w-4xl mx-auto">
        @if(isset($isTestMode) && $isTestMode)
            <!-- Test Mode Banner -->
            <div class="bg-gradient-to-r from-yellow-400 to-orange-500 text-white rounded-lg p-4 mb-6 shadow-lg border-2 border-yellow-600">
        ...
        @if($user)
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-gray-800 mb-2">الملف الشخصي</h1>
            </div>

            <!-- User Information Card -->
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-6 transform hover:scale-[1.01] transition-transform duration-300">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 transform hover:scale-[1.01] transition-transform duration-300">
                <div class="flex items-center mb-6">
                    <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-white shadow-lg">
                ...
                @elseif($subscription)
                    <div class="grid md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border-2 border-purple-200">
                            ...
                            <p class="text-2xl font-bold text-purple-700">{{ $subscription['expiration_date'] }}</p>
                        </div>

                        <!-- Subscription Name -->
                        <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg p-4 border-2 border-indigo-200">
                            <p class="text-gray-600 text-sm mb-2">نوع الاشتراك</p>
                            <p class="text-xl font-bold text-indigo-700">{{ $subscription['subscription_name'] }}</p>
                        </div>

                        <!-- Operator -->
                        <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg p-4 border-2 border-pink-200">
                            <p class="text-gray-600 text-sm mb-2">المشغل</p>
                            <p class="text-xl font-bold text-pink-700">{{ $subscription['operator'] }}</p>
                        </div>
                    </div>

                    @if(strtolower($subscription['status']) === 'active')
                        <!-- Cancel Subscription Button -->
                        <div class="mt-8 p-6 bg-gradient-to-br from-red-50 to-orange-50 rounded-xl border-2 border-red-200">
                            ...
                            <button 
                                ...
                                class="w-full md:w-auto bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center mx-auto"
                            >
